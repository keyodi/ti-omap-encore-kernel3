...
#define OMAP3630_VDD_MPU_OPP110_UV		1300000
...
struct omap_volt_data omap36xx_vddmpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP110_UV, 0, OMAP3630_CONTROL_FUSE_OPP120_VDD1, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP3630_VDD_MPU_OPP120_UV, 0, OMAP3630_CONTROL_FUSE_OPP1G_VDD1, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
static struct omap_opp_def __initdata omap36xx_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
				800000000, OMAP3630_VDD_MPU_OPP110_UV),
	/* MPU OPP4 - OPP-SB */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
				1100000000, OMAP3630_VDD_MPU_OPP120_UV),
	/* MPU OPP5 - OPP-SB2 */
	OPP_INITIALIZER("mpu", "dpll1_ck", "mpu_iva", true,
...
static struct omap_vdd_dep_volt omap36xx_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP3630_VDD_MPU_OPP110_UV, .dep_vdd_volt = OMAP3630_VDD_CORE_OPP100_UV},
